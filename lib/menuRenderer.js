var displayMenu = function (flatMenu) {
    ...
    var menuWithDividersInformations = findDividersInformations(menuWithLinksInformations);
    var menuWithFoldersInformations = findFoldersInformations(menuWithDividersInformations);
...
var findDividersInformations = function (menu) {
    menu.forEach(function (elt) {
        if (elt.text == "DIVIDER") {
            elt.isDivider = true;
        } else {
